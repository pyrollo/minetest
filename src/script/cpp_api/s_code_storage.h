...
{
public:
	bool getSourceCode(lua_State *L, const char *path, std::string &source_code, std::string &chunk_name);
	void addSourceCode(const std::string &mod, const std::string &path, const std::string &source_code);
private:
