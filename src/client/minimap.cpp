...
Minimap::Minimap(Client *client)
{
	...
	addMode(MINIMAP_TYPE_OFF,     "hidden", 0, "");
	addMode(MINIMAP_TYPE_SURFACE, "surface mode, Zoom x1", 256, "");
	addMode(MINIMAP_TYPE_SURFACE, "surface mode, Zoom x2", 128, "");
	addMode(MINIMAP_TYPE_SURFACE, "surface mode, Zoom x4", 64, "");
	addMode(MINIMAP_TYPE_RADAR,   "radar mode, Zoom x1", 512, "");
	addMode(MINIMAP_TYPE_RADAR,   "radar mode, Zoom x2", 256, "");
	addMode(MINIMAP_TYPE_RADAR,   "radar mode, Zoom x4", 128, "");
